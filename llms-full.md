...
- 主要示唆: GIS、データ可視化、OSINTは、公開情報を検証可能な形で読み解く情報メディア教育の中核になる。 / AIは結論を代行するのではなく、観察、仮説比較、説明の点検を支援する対話的編集者として使う。 / 日本テレビや読売新聞との共同研究事例は、教育・報道・社会課題を接続する実践モデルになる。
...
- 主要示唆: 生成AI時代のデジタルシティズンシップは、禁止や管理ではなく、技術社会への判断と参加を学ぶ教育である。 / AI出力を疑い、根拠を確認し、他者や社会への影響を考える力が中核になる。 / AIリテラシーは情報モラル、メディアリテラシー、公共性の学習と統合して扱う必要がある。
