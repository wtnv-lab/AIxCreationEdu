...
- [AIを活かしたデジタルシティズンシップ教育](reports/03-digital-citizenship.md): 生成AI時代のデジタルシティズンシップ教育を、禁止や管理ではなく、技術がある社会でどう判断し参加するかを学ぶ教育として再定義する。AIの出力を疑い、根拠を確認し、他者や社会への影響を考えながら表現する力を、情報リテラシー、メディアリテラシー、公共性の学習として整理する。
