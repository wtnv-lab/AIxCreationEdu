...
function renderHome() {
  ...
  return `
    <section class="home-intro">
      ...
      <p>各レポートは、著者それぞれの研究資料・実践記録・参考文献を生成AIが読み解き、著者との対話を重ねながら構成したものです。AIの下書きをそのまま置くのではなく、人間が根拠、文脈、表現を確認しながら編集しています。</p>
      <p>このページでは、そのリソースを人間の読者がたどりやすい形で表示しています。AIに内容を扱わせたい場合は、Markdown本文やメタデータ、プロンプトを含むソースコードをGitHubで公開しています。</p>
    </section>
