...
version: "1.0.0"
kind: "report"
abstract: "東京大学の情報メディア教育を軸に、データ可視化、デジタルアーカイブ、OSINTを組み合わせ、公開情報を検証可能な形で読み解き社会へ伝える学習モデルを示す。生成AIは結論を代行するのではなく、観察結果の言語化、仮説比較、推論の飛躍の点検を支える対話的な編集者として位置づけられる。"
audience:
...
key_takeaways:
  ...
  - "日本テレビや読売新聞との共同研究事例は、教育・報道・社会課題を接続する実践モデルになる。"
use_cases:
...
citation_note: "GIS・情報可視化・OSINTを組み合わせた情報メディア教育モデル。"
themes:
  - "生成AI"
  - "情報可視化"
  - "OSINT"
...
近年は，この方法をOSINT教育にも展開している。ここで重視するのは，AIS，衛星画像，公開報道，SNS上の専門的知見といった多様な公開情報を，ばらばらの断片として扱うのではなく，出所，時刻，空間的位置，解釈の確度を照合しながら，一つの検証可能な説明へ組み立てることである。ホルムズ海峡周辺の船舶動向，戦災・災害，山林火災などを扱う実践では，学生は「何が起きたか」を急いで断定するのではなく，どこまでが観察で，どこからが推論なのかを区別する態度を学ぶ。noteマガジン「戦災・災害のOSINT」に記録される実践群やBellingcatのオンライン調査ツールキットは，公開情報を用いた調査報道や市民調査の方法論を教育へ接続する参照点となる。
